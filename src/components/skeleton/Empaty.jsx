  ...
  return (
    <section>
      <div className="container min-h-[50vh] flex flex-col items-center justify-center">
        ...
        <button
          className="border px-3 py-1 h-10 cursor-pointer rounded-border-radius hover:bg-black active:bg-black hover:text-white active:text-white duration-300 text-lg font-semibold"
          onClick={() => navigate("/")}
        >
          Home
        </button>

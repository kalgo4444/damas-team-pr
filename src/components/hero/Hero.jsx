  ...
  return (
    ...
    >
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="bg-white/70 rounded-[10px] pt-[40px] px-[20px] sm:px-[30px] md:pl-[39px] md:pt-[62px] md:w-[643px] md:h-[443px] md:ml-[638px] md:mt-[80px] w-full max-w-[95%]">
          ...
          <p className="text-[#333333] font-poppins text-[16px] md:text-[18px] font-medium leading-[22px] md:leading-[24px] tracking-[0px] text-left mt-[17px]">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut<br className="hidden sm:block" />
      ...
      <h1 className="text-white text-xl sm:text-2xl md:text-4xl font-bold absolute top-6 sm:top-10">{text}</h1>
    </div>
  );
};

...
const TopHeader = ({ data }) => {
	return (
		<div className='h-[100px] bg-second w-full flex items-center'>
			<div className='container text-sm sm:text-base flex items-center gap-4'>
				...
				<span>{">"}</span>
				<span className='pl-5 py-1.5 border-l-2 border-gray-400 cursor-pointer'>{data?.title}</span>
			</div>
		</div>
	);
};
